            ...
            <div className="">
              ...
              <div className="w-[360px] bg-[#F8F8FD] h-[440px] rounded-md py-4 px-5">
                <div className="flex items-center justify-between mt-8">
                  <div className="flex items-center gap-x-3">
                    {CheckOutSight ? (
                      ...
                      <div
                        className="w-[15px] h-[15px] border-2 border-zinc-400 rounded-full cursor-pointer"
                  ...
                  <p className="text-[18px] font-Roboto">
                    <span className="text-[17px] ">৳</span> 109.00
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <p className="text-[18px] font-Roboto">
                    <span className="text-[17px] ">৳</span> 59.00
                  </p>
                </div>
                ...
                <div className="mt-8 flex items-center gap-x-2">
                  ...
                  <p className="text-[14px] font-Josefin__Sans">
                ...
                <div className="mt-8 mb-8">
                  <button
                    className="bg-[#19D16F] py-3 w-full rounded text-white font-Roboto font-bold hover:bg-green-600"
                    onClick={HandleOderButton}
                  >
                    PLACE ORDER
                  </button>
                </div>
