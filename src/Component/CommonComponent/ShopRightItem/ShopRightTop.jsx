              ...
              <div className="flex items-center gap-x-3 ">
                <div
                  className={` cursor-pointer text-[18px] ${
                    changeIcon ? "" : "text-button_Color"
                  }`}
                  onClick={HandleGrideChange2}
                >
                  <BsFillGridFill />
                </div>
                <div
      ...
      <div className="pb-10 ">
        <div className="flex items-center gap-x-3 relative">
          ...
          <div className="max-sm:block hidden">
            <div
              className="flex items-center bg-zinc-100 w-[66px] px-2 rounded-full border-2 cursor-pointer"
              onClick={HandleSort}
            >
              <p className="font-Josefin__Sans">Sort</p>
              {Sort ? (
                <IoCaretUpSharp className="text-[20px]" />
              ) : (
          ...
          <div
            ...
            className="max-sm:block md:block lg:hidden max-sm:ml-0 md:ml-[650px] max-md:ml-[540px]"
          >
            <div className="flex ">
          ...
          <div
            className={`blackOverlay w-full h-[1503px]  fixed duration-500 z-50`}
            style={{
          ...
          >
            <div
              className=" h-full w-[300px] md:w-[550px] bg-white absolute duration-500 mt-[566px] md:mt-[570px]"
              style={{
                right: Filter ? "0%" : "-100%",
              }}
